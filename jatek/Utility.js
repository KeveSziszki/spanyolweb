class Utility {
    ...
    static enumerateNeighbors(cellCenter, range, level, game, callback, drawn = undefined) {
        ...
        for (var d = 0; d < directionEven.length; d++) {
            ...
            if (cellCenter.Col % 2 == 0)
                dirs = directionEven;
            let cPos = new Pont(Utility.Clamp(cellCenter.Col + dirs[d].x, 0, game.Cols - 1), Utility.Clamp(cellCenter.Row + dirs[d].y, 0, game.Rows - 1));
